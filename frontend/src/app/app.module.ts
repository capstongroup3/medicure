...
import { AddAppointmentDialogComponent } from './component/add-appointment-dialog/add-appointment-dialog.component';
...
@NgModule({
  ...
  providers: [UserService, AppointmentService,AssessmentService, AuthGuard],
